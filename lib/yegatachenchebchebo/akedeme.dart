...
class Akedeme extends StatefulWidget{
  @override
  _AkedemePageState createState() => _AkedemePageState();
}
class _AkedemePageState extends State<Akedeme>{
  @override
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('አቀድም'),
                          _buildContent2(
                            /*0*/ 'አቀድም አእኮቴቶ ለእግዚአብሔር',
                            /*1*/ 'በእንተ እግዚእነ ኢየሱስ ክርስቶስ',
                            /*3*/ 'ትርጉም ፡- ',
                            /*4*/ 'ስለ ጌታችን አምላካችን ኢየሱስ ክርስቶስ ምስጋና ለእግዚአብሔር አስቀድማው',
