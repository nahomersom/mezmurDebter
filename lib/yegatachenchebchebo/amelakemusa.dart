...
class AmlakeMusa extends StatefulWidget{
  @override
  _AmlakeMusaPageState createState() => _AmlakeMusaPageState();
}
class _AmlakeMusaPageState extends State<AmlakeMusa>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('አምላከ ሙሴ'),
                          _buildContent2(
                            /*0*/ 'አምላከ ሙሴ ወአሮን ወአምላከ እዝራ',
                            /*1*/ 'ሰውረነ/3/ ይእዜ እም መከራ',
                            /*3*/ 'ትርጉም ፡- ',
                            /*4*/ 'የሙሴ እና የአሮን የእዝራ አምላክ ዛሬም ከመከራ ሰውረን',
