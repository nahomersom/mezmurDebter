...
class Etedegefene extends StatefulWidget{
  @override
  _EtedegefenePageState createState() => _EtedegefenePageState();
}
class _EtedegefenePageState extends State<Etedegefene>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('ኢትግድፈነ'),
                          _buildContent2(
                            /*0*/ 'ኢትግድፈነ/2/ ወኢትጸመንነነ',
                            /*1*/ 'አምላከ ሠላም ተራድአነ/2/',
                            /*3*/ 'ትርጉም ፡- ',
                            /*4*/ 'አቤቱ አትተወን አትጣለን የሰላም አምላክ እርዳን ተራዳን',
