...
class AmaneBeAmane extends StatefulWidget{
  @override
  _AmaneBeAmanePageState createState() => _AmaneBeAmanePageState();
}
class _AmaneBeAmanePageState extends State<AmaneBeAmane>{
  @override
