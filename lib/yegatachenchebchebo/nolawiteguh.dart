...
class NolawiTeguh extends StatefulWidget{
  @override
  _NolawiTeguhPageState createState() => _NolawiTeguhPageState();
}
class _NolawiTeguhPageState extends State<NolawiTeguh>{
  @override
