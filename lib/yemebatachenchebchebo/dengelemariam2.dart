...
class DengelMariam2 extends StatefulWidget{
  @override
  _DengelMariam2PageState createState() => _DengelMariam2PageState();
}
class _DengelMariam2PageState extends State<DengelMariam2>{
  @override
