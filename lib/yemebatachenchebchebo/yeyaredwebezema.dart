...
class YeYaredWebZema extends StatefulWidget{
  @override
  _YeYaredWebZemaPageState createState() => _YeYaredWebZemaPageState();
}
class _YeYaredWebZemaPageState extends State<YeYaredWebZema>{
  @override
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          ...
                          'ከጎኔ ነሽ ስልሽ እጽናናለው\n'
                          'እሳት ገደሉን ሁሉንም አልፈዋለው\n'
                          '   ትውልዱ በሙሉ ለምስጋና ይቁም\n'
                          '   ባንቺ ስለሆነ የጠፋለት መርገም\n'
                          '   አዳም ከነልጁ በሰማይ በምድር\n'
                          '   ማርያም ማርያም ይበል ታአምርሽን ይናገር\n'
                          '   ጨለማው ከፊቴ ተገፈፈ\n'
                          '   ማርያም በምልጃሽ ልቤ አረፈ\n'
                          '   ከጎኔ ነሽ ስልሽ እጽናናለው\n'
                          '   እሳት ገደሉን ሁሉንም አልፈዋለው\n'
