...
class Asetarekign extends StatefulWidget{
  @override
  _AsetarekignPageState createState() => _AsetarekignPageState();
}
class _AsetarekignPageState extends State<Asetarekign>{
  @override
