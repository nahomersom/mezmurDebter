...
import 'package:golamezmurdebter/emebatachenchebchbo.dart';
class HannaEmanest extends StatefulWidget{
  @override
  _HannaEmanestPageState createState() => _HannaEmanestPageState();
}
class _HannaEmanestPageState extends State<HannaEmanest>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('ሃና እማንስት'),
                          _buildContent2(
                            /*0*/ 'ሃና እማንስት ተአብይወትትለአል እስመ ወላደታ',
                            /*1*/ 'ለድንግል ለቅድስት ድንግል',
                                  'ዘወለደት ቃል በከመ ዜነወ በወንጌል ዮሐንስ ወንጌል',
                            /*3*/ 'ትርጉም ፡- ',
                            /*4*/ 'ሀና ከሴቶች ሁሉ ትበልጣለች ዮሐንስ በወንጌል እንደተናገረው ጌታን የወለደችው ድንግል ማርያምን ወልዳችና',
