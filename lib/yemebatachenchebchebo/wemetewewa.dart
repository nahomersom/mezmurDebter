...
class Wemetewewa extends StatefulWidget{
  @override
  _WemetewewaPageState createState() => _WemetewewaPageState();
}
class _WemetewewaPageState extends State<Wemetewewa>{
  @override
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('ወመጠውዋ'),
                          _buildContent2(
                            /*0*/ 'ወመጠውዋ ፅዋ ምሉአ በእደዊሆሙ ለመላእክት',
                            /*1*/ 'ማርያም/4/ ማርያምሰ እንተ በምድር ታንሶሶ',
                            /*3*/ 'ትርጉም ፡- ',
                            /*4*/ 'ከመላእክት እጅ ሙሉ የሆነ ጽዋ ተቀበለች ማርያም በምድር ትምላለሳለች',
