...
class Lemegnelene extends StatefulWidget{
  @override
  _LemegnelenePageState createState() => _LemegnelenePageState();
}
class _LemegnelenePageState extends State<Lemegnelene>{
  @override
