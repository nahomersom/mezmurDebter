...
class MariamTeabi extends StatefulWidget{
  @override
  _MariamTeabiPageState createState() => _MariamTeabiPageState();
}
class _MariamTeabiPageState extends State<MariamTeabi>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('ማርያም ተዐቢ'),
                          _buildContent2(
                            /*0*/ 'ማርያም ተዐቢ እም ኲሉ ፍጥረት',
                            /*1*/ 'ኢያውአያ እሳተ መለኮት',
                            /*3*/ 'ትርጉም ፡- ',
                            /*4*/ 'ማርያም ትበልጣለች ከሁሉም ፍጥረት ሰለያዘች የመለኮት እሳት',
