...
class BemenBemen extends StatefulWidget{
  @override
  _BemenBemenPageState createState() => _BemenBemenPageState();
}
class _BemenBemenPageState extends State<BemenBemen>{
  @override
