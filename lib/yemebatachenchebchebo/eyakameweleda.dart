...
class EyakemWeleda extends StatefulWidget{
  @override
  _EyakemWeledaPageState createState() => _EyakemWeledaPageState();
}
class _EyakemWeledaPageState extends State<EyakemWeleda>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('እያቄም ወለዳ'),
                          _buildContent2(
                            /*0*/ 'እያቄም ወለዳ ኢያቄም',
                            /*1*/ 'ዳዊት ዘመዳ ኢያቄም ወለዳ/2',
                            /*3*/ 'ትርጉም ፡- ',
                            /*4*/ 'የኢያቄም ልጅ የዳዊት ዘመድ ናት',
