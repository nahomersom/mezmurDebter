...
class BeAmsaleAfe extends StatefulWidget{
  @override
  _BeAmsaleAfePageState createState() => _BeAmsaleAfePageState();
}
class _BeAmsaleAfePageState extends State<BeAmsaleAfe>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('በአምሳለ ኦፍ'),
                          _buildContent2(
                            /*0*/ 'በአምሳለ ኦፍ/2/ፀአዳ ርግብ ትመስል ማርያም ድንግል',
                            /*1*/ 'ይእትኬ ማርያም ድንግል እም ደመና ዘይብል እሙ ለእግዚአ',
                            /*3*/ 'ትርጉም ፡- ',
                            /*4*/ 'በወፍ አምሳል ነጭ እርግብ የምትመስል ታየች ይህቺውም ድንግል ማርያም ነች',
