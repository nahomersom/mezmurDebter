...
class Sealinene extends StatefulWidget{
  @override
  _SealinenePageState createState() => _SealinenePageState();
}
class _SealinenePageState extends State<Sealinene>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('ሰአሊ ለነ'),
                          _buildContent2(
                            /*0*/ 'ሰአሊ ለነ ማርያም ሰአሊ ለነ',
                            /*1*/ 'አክሊለ ንጹሐን/2/ ሰአሊ ለነ',
                            /*3*/ 'ትርጉም ፡- ',
                            /*4*/ 'ለምኝልን ማርያም ለምኝልን',
                                  'የንጹሐን አክሊል/2/ ለምኝልን',
