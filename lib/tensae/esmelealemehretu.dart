...
class EsemelealemMehretu extends StatefulWidget{
  @override
  _EsemelealemMehretuPageState createState() => _EsemelealemMehretuPageState();
}
class _EsemelealemMehretuPageState extends State<EsemelealemMehretu>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('እስመ ለዓለም ምሕረቱ'),
                          _buildContent2(
                            'እስመ ለዓለም ምሕረቱ/2/',
                            'አያልቅም ብዙ መው የአምላክ ቸርነቱ',
                            '    አመስግኑት ጌታን ሁላችሁ በአድነት',
