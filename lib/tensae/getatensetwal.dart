...
class  GetaTensetwal extends StatefulWidget{
  @override
  _GetaTensetwalPageState createState() => _GetaTensetwalPageState();
}
class _GetaTensetwalPageState extends State<GetaTensetwal>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('ጌታ ተነስቷል'),
                          _buildContent2(
                            'የጌታ ተነስቷል እልል እልል በሉ',
                            'አምላክ ተነስቷል የምስራች በሉ',
                            'ሙስና መቃብር በኀይሉ አጥፍቶ',
                            ...
                            '     ሞትን በሞት ሽሮ ይኽው አየነው',
                            'ደቀ መዛሙርቱ እጅጉን ተጨንቀው',
                            'በጌታችን መሞት በሃዘን ተመልተው',
                            'በተዘጋ ደጃፍ ተሰብስበው ሳለ',
                            'እጆቹን ዘርግቶ ሰላም ለእናንተ አለ/2/',
                            '    ማርያም መቅደላዊት እየገሰገሰች',
                            '    በሌሊት ተነስታ ወደ አምላኳ ሄደች',
                            '    አይሁድ አንገላተው የሰቀሉት ጌታ',
                            '    ተነስቶ አግኝታው ተመላች ደስታ/2/',
