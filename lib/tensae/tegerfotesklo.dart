...
class TegerfoTeseklo extends StatefulWidget{
  @override
  _TegerfoTesekloPageState createState() => _TegerfoTesekloPageState();
}
class _TegerfoTesekloPageState extends State<TegerfoTeseklo>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('ተገርፎ ተሰቅሎ'),
                          _buildContent2(
                            'ተገርፎ ተሰቅሎ የሞተው አንበሳ',
                            'ተገንዞ በጨርቅ ተቀብሮ እንደ ሬሳ',
                            'በሞት አጅ ተይዞ አልቀረም ተነሳ',
                            '       እናምናን ትንሳኤህን',
                            '       በስልጣንህ መነሳትህን',
                            '       አርአያ ነውና ለሁላችን',
                            'አፈር ቢረበረብ ሳጥን ቢደረደር',
                            'ድንጋ በድንጋይ ላይ ደግሞም ቢነባበር',
