...
class BirhaneWeta extends StatefulWidget{
  @override
  _BirhaneWetaPageState createState() => _BirhaneWetaPageState();
}
class _BirhaneWetaPageState extends State<BirhaneWeta>{
  @override
                      ...
                      child: ListView(
                        ...
                        children:[
                          ...
                          _buildContent2(
                            ...
                            '      የሚወደው ሃዋርያ የወንጌል መምህር',
                            '      ዮሐንስም ስቅለቱን በማየቱ',
                            '      ሲያዝን ኖረ በምድራዊ ሕይወቱ',
                            '      ቢያሰቅቀው ሞቱ ግርፋቱ',
                            'ሞኝነት ነው ለሚጠፉት መሰናከያቸው',
                            'በዓለም ጥበብ ለሚኖሩ እውነት ተስኖአቸው',
                            'ለጠቢብ ሰው በመንፈስ ለሚኖረው',
                            'የመዳ ቀን እውነተኛ አርማ ነው',
                            'ከገሃም እሳት የሚያድነው',
                            '      እስከ መሞት ላልተለየው ቅዱስ ሃዋርያ',
  ...
  Widget _buildContent2(String name,String name1,String name2,
      ...
      String name12,String name13,
      String name14,String name15,String name16,
