...
class MutanLetasenesa extends StatefulWidget{
  @override
  _MutanLetasenesaPageState createState() => _MutanLetasenesaPageState();
}
class _MutanLetasenesaPageState extends State<MutanLetasenesa>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('ሙታን ልታስነሳ'),
                          _buildContent2(
                            'ሙትን ልታስነሳ ድውይን ልትፈውስ',
                            'ስልጣን ተሰጥቶህ ነበር ኢየሱስ ክርስቶስ',
                            'ልታስር ልትፈታ በነፍስም በሥጋ',
                            'ሥልጣን ሰጥቶህ ነበር አልፋና ኦሜጋ',
                            '      ምን ሰጡህ ይሁዳ አይሁድ ወገኖችህ',
                            '      ለእነርሱ አሳልፈህ ጌታህን የሰጠህ',
                            'ከሁሉ የሚበልጥ ስልጣን ሰጥቶህ ሳለ',
                            'ብርን ለመቀበል ልብህ ተታለለ',
                            '      ሰማይና ምድር በቃሉ የፈጠረ',
                            '      እንዴት በመቃብር ሥስት ቀን አደረ',
                            'አንት የሰጠኸው አሳልፈህ ለሞት',
                            'ሞትን ድል አድርጎ ተነስቶአል በሰንበት',
