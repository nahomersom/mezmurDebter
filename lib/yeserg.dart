...
class YeSerg extends StatefulWidget{
  @override
  _YeSergPageState createState() => _YeSergPageState();
}
class _YeSergPageState extends State<YeSerg>{
  @override
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        children:[
                          _buildContent('ደመቀ አበራልን'),
                          _buildContent2('መርዓዊ ሰማያዊ'),
                          _buildContent3('ሶበ ሰማዕነ'),
                          _buildContent4('ሙሽሮች እንኳን ደስ አላችሁ'),
                          _buildContent5('ኑ ተመልከቱልኝ'),
                          _buildContent6('ድንቅ ነው በጣም'),
                          _buildContent7('ንፅሕት ድንግል'),
                          _buildContent8('እልል እልል'),
                          _buildContent9('ሙሽራው '),
                          _buildContent10('አጅቡት በእልልታ'),
                          _buildContent11('ቃና ዘገሊላ'),
                          _buildContent12('ደስ አላቸው'),
                          _buildContent13('ሥላሴ ይባርኳችሁ'),
                          _buildContent14('የሀብከ ዮም'),
                          _buildContent15('ተክሊል አድርገህ '),
                          _buildContent16('እንቀበለው'),
                          _buildContent17('አፁብ ድንቅ'),
                          _buildContent18('አዲስ ጎጆ'),
                          _buildContent19('የዶኪማስን እመቤት'),
                          _buildContent20('በሠርጋችሁ ቀን'),
                          _buildContent21('የክብሯ መግለጫ'),
                          _buildContent22('ቤታችን ይቀደስ'),
                          _buildContent23('ደስ አላቸው'),
                          _buildContent24('ሙሽራው ከሙሽሪት ጋር'),
                          _buildContent25('አፁብ ነው ድንቅ ነው'),
                          _buildContent26('ጌታ ሆይ እባክህ'),
                          _buildContent27('መጥተዋል ጌታ'),
                          _buildContent28('የቃናው ደስታ'),
                          _buildContent29('ሙሽራው ደስ ይበልህ'),
                          _buildContent30('ተነሽ ሙሽራዬ'),
                          _buildContent31('እሰይ እሰይ'),
                          _buildContent32('አምሮ ሲያበራ'),
                          _buildContent33('ሙሽራዬ'),
                          _buildContent34('በሠርጋችን ዕለት'),
                          _buildContent35('እስመ ለዓለም'),
                          _buildContent36('የምስራች ደስ ይበላችሁ'),
                          _buildContent37('ግነዩ ለእግዚአብሔር'),
                          _buildContent38('ወገዳሙኒ'),
                          _buildContent39('ተገናኙ'),
                          _buildContent40('ተፈስሒ ቤተክርስቲያን'),
                          _buildContent41('ቃና ዘገሊላ በእመብርሃን'),
                          _buildContent42('የቤታችን ራስ'),
                          _buildContent43('እንደ አብርሃም'),
                          _buildContent44('እግዚአብሔር ፈቅዶ'),
                        ],
                      ),
                    ),
                  )
