...
class MahdeereMelekot extends StatefulWidget{
  @override
  _MahdeereMelekotPageState createState() => _MahdeereMelekotPageState();
}
class _MahdeereMelekotPageState extends State<MahdeereMelekot>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('ማኅደረ መለኮት'),
                          _buildContent2(
                            'ማኅደረ መለኮት/2/',
                            'ማርያም ፅርሕ ንፅሕይት',
                            'ትርጉም፡-',
                            'የመለኮት ማደርያ የሆንሽ እመቤታችን ማርያም የብዙሃን እናት ነሽ',
