...
class MesreteHiwot extends StatefulWidget{
  @override
  _MesreteHiwotPageState createState() => _MesreteHiwotPageState();
}
class _MesreteHiwotPageState extends State<MesreteHiwot>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('መሠረተ ሕይወት'),
                          _buildContent2(
                            'መሠረተ ሕይወት ማርያም ወጥንተ መድኃኒት ',
                            'ዘእም ቀዶሙ',
                            'ለወልድኪለ/2/አምሳለ ለእሙ/2/',
                            'ትርጉም፡-',
                            'በልጅሽ አምሳል የቀድሞ የጥንት መድኀኒት የህይወት መሠረት ማርያም ነሽ ',
