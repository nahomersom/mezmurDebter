...
class AbiyZema extends StatefulWidget{
  @override
  _AbiyZemaPageState createState() => _AbiyZemaPageState();
}
class _AbiyZemaPageState extends State<AbiyZema>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('አብይ ዜማ'),
                          _buildContent2(
                            'አብይ ዜማ ተሰምአ',
                            'እንዘይነብር ወልድ ዲበ መንበሩ ሚካኤል ',
                            'ወገብርኤል ትንሣኤዉን ዘመሩ',
