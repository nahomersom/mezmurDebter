...
class HidarMichael extends StatefulWidget{
  @override
  _HidarMichaelPageState createState() => _HidarMichaelPageState();
}
class _HidarMichaelPageState extends State<HidarMichael>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        children:[
                          _buildContent('ቀዋምያን'),
                          _buildContent2('ወሚካኤል አሐዱ'),
                          _buildContent3('ምስለ ሚካኤል(ንዒ ሰናይትየ)'),
                          _buildContent4('ሊቀ መላዕክት'),
                          _buildContent5('ሚካኤል ስዩም'),
                          _buildContent6('በአምሳለ ርግብ'),
                          _buildContent7('ዘውገ ሚካኤል'),
                          _buildContent8('ይአጥኑ'),
                          _buildContent9('ጎሥዐ ልብየ'),
                          _buildContent10('ሰአል ወጸልይ'),
                          _buildContent11('ከመትባርከነ'),
                          _buildContent12('በእደ መልአኩ ይዕቀበነ'),
                          _buildContent13('ሴሴይክሙ መና'),
                          _buildContent14('ሚካኤል እመላዕክት'),
                          _buildContent15('ውዕቱ ሊቆሙ'),
                          _buildContent16('ረዳኤ ይኩነነ'),
                          _buildContent17('ሰፊሆ ክነፊሁ'),
                          _buildContent18('መልአከ ሰላምነ'),
                          _buildContent19('መልአከ ሰላምነ'),
                          _buildContent20('ቀውምየ'),
                          _buildContent21('አንተኑ ሚካኤል'),
                          _buildContent22('ዓይኑ ዘርግብ'),
                          _buildContent23('ልዑል ውእቱ'),
                          _buildContent24('ዝኬ ውእቱ'),
                          _buildContent25('መልአከ ሰላምነ'),
                          _buildContent26('ኦ ሚካኤል'),
                          _buildContent27('ሚካኤል ሊቅ'),
                          _buildContent28('ዝንቱ ኩሉ'),
                          _buildContent29('ነዋ ሚካኤል'),
                          _buildContent30('ቅዱስ ሚካኤል መልአከ ልዑል'),
                          _buildContent31('እሰይ ተከበረ'),
                          _buildContent32('ታላቁ ሚካኤል'),
                          _buildContent33('ዘወትር አትለየን'),
                          _buildContent34('ሚካኤል በክንፉ'),
                          _buildContent35('ሚካኤል ግባ በሰላም'),
                          _buildContent36('ሚካኤል ወዳጄ'),
                        ],
                      ),
                    ),
                  )
