...
class MeskelBezachn extends StatefulWidget{
  @override
  _MeskelBezachnPageState createState() => _MeskelBezachnPageState();
}
class _MeskelBezachnPageState extends State<MeskelBezachn>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('መስቀል ቤዛችን'),
                          _buildContent2(
                            'መስቀል ቤዛችን ነው ድል መንሻ ኀይላችን',
                            'ከኃጥያት በሽታ የሚፈውሰን',
                            'በኃጥያት ጨለማ ተውጠን ሳለን',
