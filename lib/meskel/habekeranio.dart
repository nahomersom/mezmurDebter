...
class HabeKeranio extends StatefulWidget{
  @override
  _HabeKeranioPageState createState() => _HabeKeranioPageState();
}
class _HabeKeranioPageState extends State<HabeKeranio>{
  @override
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        children:[
                          _buildContent('ሀበ ቀራንዮ'),
                          _buildContent2(
                            '      ሀበ ቀራንዮ ደብረ መድኃኒት',
                            '      ቀራንዮ/2/ ሀበ ቀራንዮ',
                            'የመስቀሉ ቃል ለእኛ የእግዚአብሔር ኀይል ነው',
                            'ለማያምኑት ሞኝነት ነው ለእኛ ግን ሕይወት ነው',
                            '      እንመስክራለን ፈጣያችን አለ',
                            '      እንመሰክራለን አማኑኤል አለ',
                            '      እንመነው አንካደው ፈጣያችን ቸር ነው',
                            'እንመሰክራን ድንግል አማላጅ ናት',
                            'አንመሰክራለን ማርያም አማላጅ ናት',
