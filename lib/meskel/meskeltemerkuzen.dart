...
class MeskelTemerkuzen extends StatefulWidget{
  @override
  _MeskelTemerkuzenPageState createState() => _MeskelTemerkuzenPageState();
}
class _MeskelTemerkuzenPageState extends State<MeskelTemerkuzen>{
  @override
                      ...
                      child: ListView(
                        ...
                        children:[
                          ...
                          _buildContent2(
                            ...
                            '      መድኀኒት ስትፈልግ ኪራኮስን ይዛ',
                            '      መስቀሉን አገኘች የዓለሙን ቤዛ',
                            'ሙታን ተነስተው ያመሰገኑት',
                            'ዕጸ መስቀሉ ነው የዓለም መድኀኒት',
                            'መስቀል ምርኩዛችን ጎዳናው ወንጌል',
                            'ወደገነት እንጂ አንሄድም ሲዖል',
