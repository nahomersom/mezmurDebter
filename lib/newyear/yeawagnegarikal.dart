...
class YeawagNegariKal extends StatefulWidget{
  @override
  _YeawagNegariKalPageState createState() => _YeawagNegariKalPageState();
}
class _YeawagNegariKalPageState extends State<YeawagNegariKal>{
  @override
                      ...
                      child: ListView(
                        ...
                        children:[
                          ...
                          _buildContent2(
                            ...
                            '     ዓወደ ዓመቱን ባርኪልን ድንግል ማርያም',
                            'ተራራው ዝቅ ይበል ጎባጣውም ይቅና',
                            'ካልተስተካከለ መንገድ የለምና',
                            'የእግዚአብሔርን መንገድ እንመስርት ሁላችን',
                            'ማረፈያ እንዲሆነን ለመጪው ሀብታች',
                            'አዝ',
                            '    ክፋትና ተንኮል ከልባችን ይጥፋ',
